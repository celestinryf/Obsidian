...
Review this plan thoroughly before making any code changes. For every issue or recommendation, explain the concrete trades, give me an opinionated recommendation, and ask for my input before assuming a direction.
...
Evaluate:
• code organization one module structure
...
• After each section, pause and ask tor my feedback before moving on.
...
output the explanation and pros and cons of each stage's questions AND your opinionated recommendation and why a AskUserQuestion.
